...
namespace Orion::Engine::UT
{
	...
	TYPED_TEST_P(HashMapTest, DISABLED_Constructor_InitialCapacity)
	{
	...
	TYPED_TEST_P(HashMapTest, DISABLED_Constructor_InitializerList_Empty)
	{
		HashMap h = HashMap<TypeParam, TypeParam, Hash<TypeParam>, Predicate<TypeParam>, DummyAllocator>({});
		EXPECT_TRUE(h.IsEmpty());
		EXPECT_EQ(h.Size(), 0);
		EXPECT_EQ(h.ByteSize(), 0);
		EXPECT_EQ(h.Capacity(), 8);
	...
	TYPED_TEST_P(HashMapTest, DISABLED_Constructor_InitializerList)
	{
		...
		ASSERT_EQ(h.Size(), 5);
		EXPECT_EQ(h.ByteSize(), h.Size() * sizeof(typename decltype(h)::StorageType));
	...
	TYPED_TEST_P(HashMapTest, DISABLED_Constructor_Copy)
	{
	...
	TYPED_TEST_P(HashMapTest, DISABLED_Constructor_Move)
	{
		HashMap h1 = HashMap<TypeParam, TypeParam>({ Value<TypeParam>(0), Value<TypeParam>(1), Value<TypeParam>(2) });
		HashMap h2(Move(h1));

		EXPECT_EQ(h2.Size(), 3);
		EXPECT_EQ(h2.ByteSize(), h2.Size() * sizeof(typename decltype(h2)::StorageType));
	...
	TYPED_TEST_P(HashMapTest, DISABLED_Operator_Copy)
	{
		HashMap h1 = HashMap<TypeParam, TypeParam>({ Value<TypeParam>(0), Value<TypeParam>(1), Value<TypeParam>(2) });
		EXPECT_FALSE(h1.IsEmpty());
		EXPECT_NE(h1.Size(), 3);
		EXPECT_EQ(h1.ByteSize(), h1.Size() * sizeof(typename decltype(h1)::StorageType));
	...
	TYPED_TEST_P(HashMapTest, DISABLED_Operator_Move)
	{
		HashMap h1 = HashMap<TypeParam, TypeParam>({ Value<TypeParam>(0), Value<TypeParam>(1), Value<TypeParam>(2) });
		EXPECT_FALSE(h1.IsEmpty());
		EXPECT_NE(h1.Size(), 3);
	...
	REGISTER_TYPED_TEST_SUITE_P(HashMapTest,
	                            DISABLED_Constructor_InitialCapacity,
	                            DISABLED_Constructor_InitializerList_Empty,
	                            DISABLED_Constructor_InitializerList,
	                            DISABLED_Constructor_Copy,
	                            DISABLED_Constructor_Move,
	                            DISABLED_Operator_Copy,
	                            DISABLED_Operator_Move);
